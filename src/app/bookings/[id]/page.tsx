...
import { formatBookingDate, type BookingDetail, type BookingMessage } from "@/lib/bookings";
...
export default async function BookingDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ data: detailData, error: detailError }, { data: messageData }] = await Promise.all([
